...
The following instructions aim at providing the reader a good understanding of the workflow of the backend.

First, the parameters specified above are passed to and stored in a :py:class:`backend.data_class.rove_parameters.ROVE_params` object. 
