/* 
    ...
    This is a modified version of the leaflet.polylineoffset.js package
    which is an extension of leaflet.js. created by @bbecquet under the
    MIT license. The original repo can be found here:
   
    https://github.com/bbecquet/Leaflet.PolylineOffset

    The modifications are based on a fix proposed by user @extremoblando
    in pull request #21. 
...
function translatePoint(pt, dist, heading) {
    ...
    var reductor = function (dist) {
        if (map.getZoom() > 14) {
            ...
            return dist / Math.pow(2, 18 - map.getZoom())
        }
    };
