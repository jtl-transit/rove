...
class ROVE_params(object, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        with open(self.input_paths['frontend_config']) as json_file:
            ...
            self.redValues:Dict[str, str] = frontend_config['redValues']
        ...
        with open(self.input_paths['backend_config']) as json_file:
            ...
            self.backend_config:Dict[str, object] = json.load(json_file)
    ...
    def generate_date_list(self)->List[datetime.datetime]:
        ...
        if 'workalendarPath' not in self.backend_config:
            raise KeyError('can not find workalendarPath in the backend config file')
        else:
            try:
